        ...
        if mic.nod2_event.is_set():
            while True:
                ...
                if tn == 1:
                    ...
                    robot_write(tn_masaru, b"nod_human_r\n")
                elif tn == 3:
                    robot_write(tn_kiyoko, b"nod_human_l\n")
                print("sleep before")
                time.sleep(2.5)
            audio.nod_event.set()
            mic.nod2_event.clear()
        ...
        if audio.change_event.is_set():
            ...
            try:
                if val[0] == names[0]:
                    ...
                    time.sleep(2)
                    robot_write(tn_masaru, b"nod_l\n")
                    time.sleep(1)
                    robot_write(tn_kiyoko, b"nod_r\n")
                ...
                if val[0] == names[2]:
                    ...
                    time.sleep(2)
                    robot_write(tn_takashi, b"nod_l\n")
                    time.sleep(1)
                    robot_write(tn_masaru, b"nod\n")
                ...
                if val[0] == names[1]:
                    ...
                    time.sleep(2)
                    robot_write(tn_kiyoko, b"nod\n") 
                    time.sleep(1)           
                    robot_write(tn_takashi, b"nod_r\n")
...
def mainloop():
    ...
    while True:
        if args.mic:
            user_input = mic.listen(timeout=1.2, phrase_time_limit=3.0, try_again=False)
